...
export const metadata: Metadata = {
  title: "RPRT Sports + Talent Management | Premier Entertainment Services",
  description: "Elite talent and athlete management services including PR, career management, endorsements, and contract negotiations. Nearly a decade of Hollywood industry expertise.",
  keywords: "talent management, sports management, entertainment industry, public relations, contract negotiations, endorsements, celebrity management, Hollywood talent agency",
  openGraph: {
    title: "RPRT Sports + Talent Management | Premier Entertainment Services",
    description: "Elite talent and athlete management services with nearly a decade of Hollywood industry expertise.",
    siteName: "RPRT Sports + Talent Management",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/5989941/pexels-photo-5989941.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "RPRT talent management team"
    }]
  },
  twitter: {
    ...
    title: "RPRT Sports + Talent Management | Premier Entertainment Services",
    description: "Elite talent and athlete management services with nearly a decade of Hollywood industry expertise.",
    images: ["https://images.pexels.com/photos/5989941/pexels-photo-5989941.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
